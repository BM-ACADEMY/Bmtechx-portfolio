...
const FAQ = () => {
 ...
 const [showModal, setShowModal] = useState(false);
  ...
  return (
    <div className="faq-section" id="faq">
      <Container className="d-flex flex-column align-items-center py-3">
        <h1 className="text-white mb-3">{t("faqTitle")}</h1>
        ...
        <p className="text-white mt-4">{t("askQuestionText")}</p>
        <div className="mt-1 text-center bottom-btn">
          <Button variant="warning" className="question" onClick={bookFreeCall}>
            {t("askQuestionBtn")}
          </Button>
        </div>
      </Container>
